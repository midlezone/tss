...
class Course extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, cat_id, site_id, name, alias, price, price_market, status, order, image_path, image_name, created_time, modified_time, viewed, time_for_study, number_of_students, school_schedule, course_open, course_finish, sort_description, description, avatar, ishot,number_lession', 'safe'),
        );
    }
