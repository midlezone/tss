...
class CategoryPage extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, title, content, site_id, user_id, created_time, modified_time, alias, modified_by,meta_keywords, meta_description,meta_title, image_path, image_name, avatar', 'safe'),
        );
    }
