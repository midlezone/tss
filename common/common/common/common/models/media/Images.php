...
class Images extends ActiveRecord {
    ...
    public function tableName() {
        return ClaTable::getTable('image');
    }
    ...
    public function rules() {
        ...
        return array(
            ...
            array('img_id, album_id, name, path, display_name, description, alias, site_id, user_id, height, width, created_time, modified_time, resizes', 'safe'),
        );
    }
    ...
    static function getAbsoluteLink($image = null) {
        if (!$image)
            return '';
        return ClaHost::getImageHost() . $image['path'] . 's500_500/' . $image['name'];
    }
