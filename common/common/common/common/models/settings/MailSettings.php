...
class MailSettings extends ActiveRecord {
    ...
    public function tableName() {
        return ClaTable::getTable('mail_settings');
    }
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, mail_key, mail_title, mail_subject, mail_attribute, mail_msg, site_id, description, created_time, modified_time', 'safe', 'on' => 'search'),
        );
    }
