...
class Themes extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('theme_id, theme_name, theme_type, created_time, description, category_id, avatar_path, avatar_name, avatar_id, status, previewlink, basepath', 'safe'),
        );
    }
    ...
    function getThemeId() {		
        if (isset($this->theme_name) && isseit($this->theme_type)) {			
