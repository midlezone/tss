...
class Lecturer extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, name, bod, status, subject, level_of_education, avatar_path, avatar_name, description, gender, add, phone, experience, facebook, email, site_id, avatar, job_title, company, sort_description, created_time, modified_time, order, alias', 'safe'),
        );
    }
