...
class Product extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('price, price_market, price_discount', 'numerical', 'min' => 0),
            ...
            array('id, name, code, price, price_market, price_discount, price_discount_percent, include_vat, currency, quantity, status, position, avatar_path, avatar_name, avatar_id, site_id, created_user, modified_user, created_time, modified_time, product_category_id, ishot, alias, viewed, isnew, category_track, manufacturer_id, state, shop_id', 'safe'),
        );
    }
