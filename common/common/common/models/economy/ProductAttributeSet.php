...
class ProductAttributeSet extends ActiveRecord {
    ...
    public function getAttributeConfigurable($att_set_id,$att_ids=array()) {
        ...
        return ProductAttribute::model()->findAll('attribute_set_id=:attribute_set_id AND is_configurable=1 AND site_id=:site_id'.$where.' ORDER BY sort_order', array(':attribute_set_id' => $att_set_id,':site_id'=>Yii::app()->siteinfo['site_id']));
    }
