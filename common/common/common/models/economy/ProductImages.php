...
class ProductImages extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('product_id, site_id, user_id, height, width, created_time, modified_time, order', 'numerical', 'integerOnly'=>true),
			array('name, path, display_name, description, alias', 'length', 'max'=>255),
			array('resizes', 'length', 'max'=>500),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('img_id, product_id, name, path, display_name, description, alias, site_id, user_id, height, width, created_time, modified_time, resizes, order', 'safe', 'on'=>'search'),
		);
	}
