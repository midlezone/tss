...
class ProductInfo extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('product_sortdesc, product_desc, dynamic_field,list_product_relate', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('product_id, product_sortdesc, product_desc, dynamic_field, meta_title, meta_keywords, meta_description,list_product_relate, site_id', 'safe'),
        );
    }
