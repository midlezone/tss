...
class Shop extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('name, province_id, district_id, ward_id, email, description, time_open, time_close, day_open, day_close', 'required'),
            ...
            array('name, alias, address, image_name, email, yahoo, skype, website, field_business, meta_keywords, meta_description, meta_title', 'length', 'max' => 255),
            ...
            array('id, name, alias, user_id, address, province_id, province_name, district_id, district_name, ward_id, ward_name, image_path, image_name, phone, email, yahoo, skype, website, field_business, status, created_time, modified_time, avatar, site_id, allow_number_cat, meta_keywords, meta_description, meta_title, avatar_id, description, time_open, time_close, day_open, day_close, type_sell, like', 'safe'),
        );
    }
