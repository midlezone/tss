...
class RealEstateNews extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, name, alias, site_id, status, created_time, modified_time, user_id, 
			sort_description, description, address, province_id, province_name, 
			district_id, district_name, price, area, image_path, image_name, 
			cat_id, type, avatar, unit_price', 'safe'),
        );
    }
