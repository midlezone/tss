...
class Sms extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, text_message, type, group_customer_id, created_time, number_person, list_number, site_id, ary_price, ary_provider, count_message, from_datesearch, to_datesearch', 'safe'),
