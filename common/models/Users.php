...
class Users extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('name, email, password,created_time', 'required'),
            ...
            array('identity_card,level, zocoin,zoda_granted,created_identity_card, address_identity_card, front_identity_card, back_identity_card, bank_id, bank_name, bank_branch, phone_introduce, user_id, site_id, name, email, password, salt, sex, birthday, address, status, phone,point, province_id, district_id, created_time, modified_time, passwordConfirm, active, type, user_introduce_id, is_leader', 'safe'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'zocoin' => Yii::t('user', 'zocoin'),
            'zoda_granted' => Yii::t('user', 'zoda_granted'),
    ...
    public function search() {
		...
		$criteria->compare('zocoin', $this->zocoin, true);
