...
class ProductConfigurableValue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('attribute1_value, attribute2_value', 'length', 'max'=>20),
			array('multitext', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, product_id, attribute1_value, attribute2_value, attribute3_value, price, multitext, site_id', 'safe', 'on'=>'search'),
		);
	}
