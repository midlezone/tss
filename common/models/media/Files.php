...
class Files extends ActiveRecord {
    ...
    //default file size limit. default value : 100MB
    CONST LIMIT_SIZE = 104857600; //byte
    ...
    public function tableName() {
        return ClaTable::getTable('files');
    }
    ...
    public function rules() {
        ...
        return array(
            ...
            array('folder_id, user_id, site_id, created_time,publicdate, modified_time', 'numerical', 'integerOnly' => true),
            ...
            array('id, folder_id, user_id, site_id, name, path, description, display_name, extension, size, created_time, modified_time, file_src, publicdate', 'safe', 'on' => 'search'),
        );
    }
