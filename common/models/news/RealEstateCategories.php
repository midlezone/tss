...
class RealEstateCategories extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('cat_id, cat_parent, site_id, cat_name, alias, created_time, modified_time, status,
			showinhome, image_path, image_name, meta_keywords, meta_description, meta_title, 
			cat_order, cat_description, cat_countchild, avatar', 'safe'),
        );
    }
