...
class RealEstateNews extends ActiveRecord {
    ...
    public function tableName() {
        return ClaTable::getTable('real_estate_news');
    }
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, name, alias, site_id,code, status, created_time, modified_time, user_id, sort_description,
			description, address, province_id, province_name, district_id, district_name, price, area,
			image_path, image_name, cat_id, type, avatar, unit_price,utiliti,utiliti_other,cultural,status_juridical', 'safe'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
			...
			'utiliti' => Yii::t('common', 'utiliti'),
			'utiliti_other' => Yii::t('common', 'utiliti_other'),
			'cultural' => Yii::t('common', 'cultural'),
			'status_juridical' => Yii::t('common', 'status_juridical')
        );
    }
