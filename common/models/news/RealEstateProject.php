...
class RealEstateProject extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('name', 'required'),
			array('information', 'required'),
			array('scale', 'required'),
			array('progress', 'required'),
			array('location', 'required'),
			array('extension', 'required'),
			array('apartment', 'required'),
    ...
    public function attributeLabels() {
        return array(
			...
			'information' => Yii::t('common', 'information'),
			'scale' => Yii::t('common', 'scale'),
			'progress' => Yii::t('common', 'progress'),
			'location' => Yii::t('common', 'location'),
			'extension' => Yii::t('common', 'extension'),
			'apartment' => Yii::t('common', 'apartment'),
