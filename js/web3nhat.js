...
jQuery(document).ready(function() {
    ...
    if (jQuery('.product-detail .product-detail-img').length) {
        ...
        jQuery('.product-detail .product-detail-img a.product-img-small').on('mouseover', function() {
            thumb_img_w = thumb_img ? thumb_img : 500;
            thumb_img_h = thumb_img ? thumb_img : 500;
            ...
            if (href) {
                ...
                if (!thumb)
                    clo.find('.product-img-main a.product-img-large img').attr('src', src.replace('\/s50_50\/', '\/s'+thumb_img_w330+'_'+thumb_img_h+'\/'));
                else
        ...
        jQuery.ajax({
            ...
            success: function(res) {
                if (res.code == '200') {
                    ...
                    if (!thi.hasClass('noredirect') && res.redirect)
                        window.location.href = res.redirect;
                    else {
