<?php
$js = 'function updateQuantity(product_id, quantity) { if(quantity==0) {$(this).val(0);} document.location = "' . $this->createUrl('/economy/shoppingcart/update') . '/?pid=" + product_id + "&qty=" + quantity; }';
