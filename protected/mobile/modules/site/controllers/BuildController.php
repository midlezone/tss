...
//                                    die;
    ...
    function actionGeneratesql() {
        ...
        foreach ($products as $pro) {
            $sql.="INSERT INTO " . Yii::app()->params['tables']['product'] . " (id, `name`, `code`, price, price_market, price_discount, price_discount_percent, include_vat, unit, quantity, `status`, position, product_sortdesc, product_desc, avatar_path, avatar_name, avatar_id, site_id, create_user, update_user, created_time, update_time, meta_keywords, meta_description, meta_title, list_product_relate, product_category_id, ishot, alias) "
