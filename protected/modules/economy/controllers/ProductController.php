...
class ProductController extends PublicController {
    ...
    public function actionDetail($id) {
        ...
        //
		 // get hot news
        //$albums = Albums::getAlbumshot(array('limit' => 10));
        ...
        $this->render('detail', array(
			...
			array(
				'price_text' => Product::getPriceText($product->attributes),
				'price_gold' => Product::getPriceText($product->attributes, 'price_gold'),
				'price_market_text' => Product::getPriceText($product->attributes, 'price_market'),
				'price_save_text' => Product::getPriceText($product->attributes, 'price_save')
			),
