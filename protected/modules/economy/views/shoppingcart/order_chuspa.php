...
<div class="w3n-order container">
	<h2 class="product-category">ĐĂNG KÝ WEBSITE CHUSPA.VN THÀNH CÔNG</h2>
    ...
    <table width="100%" cellpadding="5" cellspacing="5" style=" border-collapse: inherit;border-spacing: 5px;">
		<div class="infor_oder">
			...
			<p>Quý khách vừa đăng ký thành công của <a href=""><?php echo $_SERVER['HTTP_HOST']; ?></a>.
			</p>
						  ...
						  <div class="bank-group-left">
							  <div class="bank-col-1">
							   ...
							   <div class="bank-col-midle">
								  <span class="bank-name">NGÂN HÀNG Vpbank</span>
								  <span class="bank-branch">chi nhánh Ngô Quyền, Hà Nội</span>
							  </div>
						  </div>
						  <div class="bank-col-2">
							  <span class="bank-acc-name">Tên tài khoản nhận: <strong>Trương Thanh Minh</strong></span>
							  <span class="bank-acc-number">Số tài khoản nhận: <strong>19455 8888</strong></span>
							  <span class="bank-money">Số tiền thanh toán: <strong>4.999.000 VNĐ</strong></span>
						  </div>
					  </div>	  
