...
<div class="clearfix layout layout-2">
            ...
            <div class="centerContent">
					...
					<?php } else { ?>
						<div class="real-estate-detail">
								...
								<div class="bire">
									<div id="img2" style="display: block;">
										<?php if ($model['image_path'] && $model['image_name']) { ?>
											<img width ="300" height="250"  src="<?php echo ClaHost::getImageHost() . $model['image_path'] . 's330_330/' . $model['image_name'] ?>" alt="<?php echo $model['name'] ?>">
										<?php } ?>	
									</div>	
									
									<div id="img3" style="width: 300px; height: 250px; display: none;">
										<div id="ComboExample"></div>
									</div>									
									<div id="tabMap">
										<ul>
											<li onclick="javascript:hidemap();" id="1" class="current"><img src="/themes/introduce/bds/css/img/pic_v2.jpg"></li>
											<li onclick="javascript:showmap();" id="3" class=""><img src="/themes/introduce/bds/css/img/bando_v2.jpg"></li>
											<li><a href="#">&nbsp;</a></li>
										</ul>
									</div>
							...
							<div id="description">
								<h4>MÔ TẢ CHI TIẾT</h3>
								<p><?php echo $model['description'] ?></p>
								<h4>TIỆN ÍCH</h3>
								<p><?php echo $model['utiliti'] ?></p>
								<h4>TIỆN ÍCH KHÁC</h3>
								<p><?php echo $model['utiliti_other'] ?></p>
								<h4>VĂN HÓA XÃ HỘI</h3>
								<p><?php echo $model['cultural'] ?></p>
								<h4>TÌNH TRẠNG PHÁP LÝ</h3>
								<p><?php echo $model['status_juridical'] ?></p>
   ...
   <script type="text/javascript">
		...
		var el=document.getElementById("ComboExample")
			el.innerHTML="<iframe name=\"IFrameName\" src=\"https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q='.<?php echo $model['address'] . ', ' . $model['district_name'] . ', ' . $model['province_name'] ?>
				.'&amp;aq=&amp;ie=UTF8&amp;hq=&amp;hnear='.$addressString.'&amp;t=m&amp;z=14&amp;iwloc=A&amp;output=embed\" width=\"300\" frameborder=\"no\" height=\"250\" scrolling=\"no\"></iframe>"
		}
		function hidemap(){
