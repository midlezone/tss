...
<div class="clearfix layout layout-2">
    ...
    <div id="contentCol">
        ...
        <div id="centerCol">
            <div class="centerContent sa1">
					 <?php
						$this->widget('common.widgets.wglobal.wglobal', array('position' => Widgets::POS_CENTER));
						?>
						<div class="wrep">
							<div id="pageTitle2">
									<div id="title" style="padding-top: 5px; text-transform: uppercase;"><?php echo $category->cat_name ?></div>
							</div>
												...
												<!--  list can giao dich -->
												 <table bgcolor="#afd0ef" width="100%" border="0" cellpadding="0" cellspacing="1" height="90">
													<tbody>
													  ...
													  <?php foreach ($list_realestate_news as $realestate) { ?>
													  
															<tr height="20">
																  <td rowspan="2" align="center" valign="middle" bgcolor="#f7fbfc" width="90">
																  <a href="<?php echo $realestate['link'] ?>" >
																  <img src="<?php echo ClaHost::getImageHost() . $realestate['image_path'] . 's200_200/' . $realestate['image_name'] ?>" width="90" height="90" alt="<?php echo $realestate['name'] ?>" border="0"></a>
																  </td>
