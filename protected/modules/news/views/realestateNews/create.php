        ...
        <div id="centerCol">
            <div class="centerContent">
					 <?php
						...
						<div class="wrep">
							<div id="pageTitle2">
									<div id="title" style="padding-top: 5px; text-transform: uppercase;">Đăng Tin</div>
							</div>
								...
								<?php if (!empty($user_id)) {
									...
									<div class="wrap_create_real_estate">
										...
										<div class="form-group w3-form-group">
											...
											<div class="col-xs-2 w3-form-field m2">
										...
										<div class="form-group w3-form-group">
											<?php echo $form->labelEx($model, 'Tiện ích', array('class' => 'col-xs-2 control-label no-padding-left')); ?>
											<div class="col-xs-10 w3-form-field">
													<?php echo $form->textArea($model, 'utiliti', array('class' => 'form-control w3-form-input input-text ','placeholder' => '')); ?>
													<?php echo $form->error($model, 'utiliti'); ?>
											</div>
										</div>
										
										 <div class="form-group w3-form-group">
											<?php echo $form->labelEx($model, 'Tiện ích khác', array('class' => 'col-xs-2 control-label no-padding-left')); ?>
											<div class="col-xs-10 w3-form-field">
													<?php echo $form->textArea($model, 'utiliti_other', array('class' => 'form-control w3-form-input input-text')); ?>
													<?php echo $form->error($model, 'utiliti_other'); ?>
											</div>
										</div>
										 <div class="form-group w3-form-group">
											<?php echo $form->labelEx($model, 'Văn hóa', array('class' => 'col-xs-2 control-label no-padding-left')); ?>
											<div class="col-xs-10 w3-form-field">
													<?php echo $form->textArea($model, 'cultural', array('class' => 'form-control w3-form-input input-text')); ?>
													<?php echo $form->error($model, 'cultural'); ?>
											</div>
										</div>
										 <div class="form-group w3-form-group">
											<?php echo $form->labelEx($model, 'tình trạng pháp lý', array('class' => 'col-xs-2 control-label no-padding-left')); ?>
											<div class="col-xs-10 w3-form-field">
													<?php echo $form->textArea($model, 'status_juridical', array('class' => 'form-control w3-form-input input-text')); ?>
													<?php echo $form->error($model, 'status_juridical'); ?>
											</div>
										</div>
