            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'view' => array(
                                'url' => 'Menus::generateUrlPageContent(Menus::getMenuLinkCategoryPage(array("oi" => $data->id)))',
                    ...
                    'translate' => array(
                        ...
                        'value' => function($data) {
                    $this->widget('application.widgets.translate.translate', array('baseUrl' => '/content/categorypage/update', 'params' => array('id' => $data->id)));
                }
                    ),
                ),
            ));
