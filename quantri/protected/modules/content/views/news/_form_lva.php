...
<div class="row">
    <div class="col-xs-12 no-padding">
        ...
        <div class="control-group form-group">
            <?php echo $form->labelEx($model, 'Thứ tự', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
            <div class="controls col-sm-10">
        ...
        <div class="control-group form-group">
            <?php echo $form->labelEx($model, 'Link_Thông Báo', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
            <div class="controls col-sm-10">
