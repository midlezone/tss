...
<div class="row">
    <div class="col-xs-12 no-padding">
		...
		<div class="control-group form-group">
            <?php echo $form->label($model, 'Mã tin', array('class' => 'col-xs-2 control-label no-padding-left')); ?>
            <div class="col-xs-3 w3-form-field">
                <?php echo $form->textField($model, 'code', array('class' => 'form-control w3-form-input input-text', 'placeholder' => Yii::t('realestate', 'Mã Tin'))); ?>
        ...
        <div class="control-group form-group">
		 ...
		 <div class="control-group form-group">
            ...
            <div class="controls col-sm-10">
                <div class="span12">
                    <?php echo $form->textArea($model, 'utiliti', array('class' => 'form-control w3-form-input input-text')); ?>
		 ...
		 <div class="control-group form-group">
            <?php echo $form->labelEx($model, 'Tiện ích khác', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
            <div class="controls col-sm-10">
                <div class="span12">
                    <?php echo $form->textArea($model, 'utiliti_other', array('class' => 'span12 col-sm-12')); ?>
                    <?php echo $form->error($model, 'utiliti_other'); ?>
                </div>
            </div>
        </div>
		 <div class="control-group form-group">
            <?php echo $form->labelEx($model, 'Văn hóa', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
            <div class="controls col-sm-10">
                <div class="span12">
                    <?php echo $form->textArea($model, 'cultural', array('class' => 'span12 col-sm-12')); ?>
                    <?php echo $form->error($model, 'cultural'); ?>
                </div>
            </div>
        </div>
		 <div class="control-group form-group">
            <?php echo $form->labelEx($model, 'tình trạng pháp lý', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
            <div class="controls col-sm-10">
                <div class="span12">
                    <?php echo $form->textArea($model, 'status_juridical', array('class' => 'span12 col-sm-12')); ?>
