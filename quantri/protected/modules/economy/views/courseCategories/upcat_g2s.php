            ...
            <div class="row">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="control-group form-group">
                        <?php echo $form->labelEx($model, 'Tên Đại Lý', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
                    ...
                    <div class="control-group form-group">
                        <?php echo $form->labelEx($model, 'Miêu Tả Cho Đại Lý', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
                        <div class="controls col-sm-10">
                    ...
                    <div class="control-group form-group buttons">
                        <?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('category', 'category_create') : Yii::t('category', 'Cập Nhật'), array('class' => 'btn btn-primary', 'id' => 'btnAddCate')); ?>
                    </div>
                    <?php
                    $this->endWidget();
                    ?>
