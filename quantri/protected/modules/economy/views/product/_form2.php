...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
		...
		CKEDITOR.replace("ProductInfo_product_exterior", {
            height: 400,
            language: '<?php echo Yii::app()->language ?>'
        });
		CKEDITOR.replace("ProductInfo_product_technical", {
            height: 400,
            language: '<?php echo Yii::app()->language ?>'
        });
    });
        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div id="basicinfo" class="tab-pane active">
                    <?php
                    $this->renderPartial('partial/tabbasicinfo2', array('model' => $model, 'productInfo' => $productInfo, 'form' => $form, 'option' => $option));
                    ?>
                </div>
