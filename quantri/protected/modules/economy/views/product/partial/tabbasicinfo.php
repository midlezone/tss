...
<div class="form-group no-margin-left">
    <?php echo $form->labelEx($model, 'Link Video', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
    <div class="controls col-sm-10">
...
<div class="form-group no-margin-left">
    <?php echo $form->labelEx($model, 'Giảm giá', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
    <div class="controls col-sm-10">                            
        <?php echo $form->checkBox($model, 'include_vat'); ?>
        <span class="lbl" style="padding:0px 5px 4px 5px; color: #999; font-size: 12px; font-style: italic;"> Tích vào nếu không giảm giá</span>
...
<div class="form-group no-margin-left">
    <?php echo $form->labelEx($model, 'ID Album', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
    <div class="controls col-sm-10">
...
<div class="form-group no-margin-left">
    <?php echo $form->labelEx($productInfo, 'Hướng Dẫn', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
    <div class="controls col-sm-10">
        <?php echo $form->textArea($productInfo, 'product_exterior', array('class' => 'span12 col-sm-12')); ?>
        <?php echo $form->error($productInfo, 'product_exterior'); ?>
    </div>
</div>
<div class="form-group no-margin-left">
    <?php echo $form->labelEx($productInfo, 'Đối tượng sử dụng', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
    <div class="controls col-sm-10">
...
<div class="form-group no-margin-left">
    <?php echo $form->labelEx($productInfo, 'Thông tin thêm', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
    <div class="controls col-sm-10">
        <?php echo $form->textArea($productInfo, 'product_technical', array('class' => 'span12 col-sm-12')); ?>
        <?php echo $form->error($productInfo, 'product_technical'); ?>
    </div>
</div>