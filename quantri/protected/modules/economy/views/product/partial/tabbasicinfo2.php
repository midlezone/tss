...
<div class="form-group no-margin-left">
    <?php echo $form->labelEx($productInfo, 'Giới Thiệu', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
    <div class="controls col-sm-10">
...
<div class="form-group no-margin-left">
    <?php echo $form->labelEx($productInfo, 'Nội Thất', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
    <div class="controls col-sm-10">
...
<div class="form-group no-margin-left">
    <?php echo $form->labelEx($productInfo, 'Ngoại Thất', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
    <div class="controls col-sm-10">
...
<div class="form-group no-margin-left">
    <?php echo $form->labelEx($productInfo, 'Thông Số Kỹ Thuật', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
    <div class="controls col-sm-10">
