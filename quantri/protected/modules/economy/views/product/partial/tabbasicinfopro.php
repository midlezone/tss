...
<div class="form-group no-margin-left">
 ...
 <div class="form-group no-margin-left">
            <?php echo $form->labelEx($model,'Ngày giờ đóng kèo', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
            <div class="controls col-sm-10">
                <?php
                $this->widget('common.extensions.EJuiDateTimePicker.EJuiDateTimePicker', array(
                    'model' => $model, //Model object
                    'name' => 'Product[publicdate]', //attribute name
...
<div class="form-group no-margin-left">
    <label class="col-sm-2 control-label no-padding-left" for="ProductInfo_product_sortdesc">Nội Dung trả về Tip</label>
    <div class="controls col-sm-10">
