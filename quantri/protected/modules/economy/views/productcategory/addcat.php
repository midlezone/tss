                    ...
                    <div class="control-group form-group">
                        ...
                        <div class="controls col-sm-10">
                            ...
                            <div id="categoryicon" style="display: block; margin-top: 0px;">
                                <div id="categoryicon_img" style="display: inline-block; max-width: 100px; max-height: 100px; overflow: hidden; vertical-align: top; <?php if ($model->icon) echo 'margin-right: 10px;'; ?>">  
                                    <?php if ($model->icon_path && $model->icon_name) { ?>
                                        <img src="<?php echo ClaHost::getImageHost() . $model->icon_path . 's100_100/' . $model->icon_name; ?>" style="width: 100%;" />
                                    <?php } ?>
                                </div>
                     ...
                     <div class="control-group form-group">
                        <?php echo $form->labelEx($model, 'Hoa hồng được hưởng cho các cấp(%)', array('class' => 'col-sm-2 control-label no-padding-left')); ?>
                        <div class="controls col-sm-10">
                             <?php echo $form->textField($model, 'percent', array('class' => 'span10 col-sm-12')); ?>                         
