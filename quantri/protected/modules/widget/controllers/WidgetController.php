...
class WidgetController extends BackController {
    ...
    public function actionPagewidgetlist() {
        ...
        $sql = "SELECT t.page_widget_id, t.widget_title, r.config_data FROM page_widgets AS t LEFT JOIN page_widget_config AS r ON r.page_widget_id = t.page_widget_id"
