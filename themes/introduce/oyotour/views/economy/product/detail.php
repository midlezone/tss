    ...
    <div class="product-detail-box">
        ...
        <div class="product-detail-info" id="product-detail-info">
            ...
            <div class="product-info-col1">
              ...
              <div class="tour-addon" style="">
						<span class="duration icon-location5" style="border-right: 1px solid #FFF;"><b>Khởi hành từ:</b>  Hà Tĩnh</span></br>
						<!-- thoi gian tour -->
						<span class="duration icon-clock5"><b>Thời gian:</b>
						<?php echo $product['code'] ?></span></br>
				</div>
    ...
    <div class="product-detail-more">
            <div class="tab">
                <ul role="tablist" class="nav nav-tabs">
                    <li class="active">
					<a data-toggle="tab" role="tab" href="#home"><?php echo 'Lịch Trình'; ?></a></li>
					<li >
					<a data-toggle="tab" role="tab" href="#home1"><?php echo 'Giá Bao Gồm'; ?></a></li>
                </ul>
