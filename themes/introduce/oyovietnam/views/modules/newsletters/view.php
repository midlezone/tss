        ...
        <div class="form-group no-margin-left no-margin-right">
            <div class="input-group email">
                ...
                <span class="input-group-addon" style="font-size: 14px;">
                    <?php echo CHtml::submitButton(Yii::t('common', 'signup'), array('class' => 'btn btn-sm', 'id' => 'newslettersubmit', 'style' => 'padding:0px 4px 0px 4px; background:#751E42; color:#fff; border-radius: 0px;  display: block;')); ?>
                </span> 
            </div>
            <div>
