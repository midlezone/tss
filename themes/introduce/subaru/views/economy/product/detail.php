            ...
            <div class="product-info-col1">
                ...
                if ($promotion && count($promotion)) {
                    ...
                    <div class="product-gif">
                        <strong class="sortdesc"><?php echo $promotion['sortdesc']; ?></strong>
                        <div class="box-product-gif-time">
                            <span>
                                <?php echo $promotion['description']; ?>
                            </span>
                            <div class="time-product">
                                <strong>Khuyến mại từ:</strong>
                                <?php
                                echo date('d-m-Y', $promotion['startdate']);
                                ?>
                                <strong>đến:</strong>
                                <?php
                                echo date('d-m-Y', $promotion['enddate']);
                                ?>
                    ...
                    <?php if ($attributesShow && count($attributesShow)) { ?>
                        <div class=product-att">
                            ...
                            foreach ($attributesDynamic as $key => $item) {
                                ...
                                if ($item['value'])
                                    echo '<label>' . $item['name'] . ':</label><span>' . $item["value"] . '</span></br>';
                            }
                            ?> 
                        </div>
                    <?php } ?>
        ...
        <?php if ($product['product_desc'] || $attributesShow && count($attributesShow)) { ?>
            <div class="tab">
                <ul role="tablist" class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" role="tab" href="#home">Giới Thiệu</a></li>
					<li > <a data-toggle="tab" role="tab" href="#home1">Ngoại Thất</a></li>
					<li > <a data-toggle="tab" role="tab" href="#home2">Nội Thất</a></li>
					<li > <a data-toggle="tab" role="tab" href="#home3">Thông Số Kỹ Thuật</a></li>
                </ul>
