			...
			<div class="hdTop">
                	<ul>
                    	<li id="language"><a class="gflag nturl" href="#" onclick="doGTranslate('vi|en');
												return false;" style="background-position:5px -0px;" title="English"><img alt="English" height="18" src="images/flag/blank.png" width="32"></a><a class="gflag nturl" href="#" onclick="doGTranslate('vi|vi');
                    ...
                    <div class="place"><span class="fa fa-map-marker"></span>&nbsp Km 516 - QL1A - Thạch Bình - Thành phố Hà Tĩnh | <span class="fa fa-life-ring"></span>   <a href="/dang-ky-lai-thu-pde,4333" title="">Đăng Ký Lái Thử</a></div> 
