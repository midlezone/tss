var StoryBox = {containerObject: {}, containerPanels: [], settings: {displayEffect: ["bounceInUp", "bounceInRight", "bounceInDown", "bounceInLeft"], hideEffect: ["bounceOutUp", "bounceOutRight", "bounceOutDown", "bounceOutLeft"]}, namespace: "storybox", Init: function(e, t) {
        ...
        this.containerObject.find("[data-sb]").each(function() {
            e.containerPanels[e.containerPanels.length] = {container: jQuery(this), displayEffect: jQuery.trim(jQuery(this).attr("data-sb")) == "" ? e.settings.displayEffect : jQuery(this).attr("data-sb").indexOf(",") != -1 ? jQuery(this).attr("data-sb").split(",") : jQuery(this).attr("data-sb"), hideEffect: typeof jQuery(this).attr("data-sb-hide") != "undefined" ? jQuery.trim(jQuery(this).attr("data-sb-hide")) == "" ? e.settings.hideEffect : jQuery(this).attr("data-sb-hide").indexOf(",") != -1 ? jQuery(this).attr("data-sb-hide").split(",") : jQuery(this).attr("data-sb-hide") : false};
            $(this).css("opacity", 0)
        })
    }, loadPanels: function() {
        var e = this;
        ...
        var e = jQuery(window).scrollTop() + jQuery(window).height(), t = this;
        jQuery.each(t.containerPanels, function(n, r) {
            if (r.container.hasClass("sb-effect-running"))
                return;
            if (e >= r.container.offset().top && e <= r.container.offset().top + r.container.height() * .7 + jQuery(window).height()) {
