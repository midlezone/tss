<section class="page_title translucent_bg_color_scheme image_bg_service image_fixed t_align_c relative wrapper">
<div class="container">
<h3 class="color_light fw_light m_bottom_5">KIỂM TRA TÊN MIỀN</h3>
</div>
</section>
                ...
                <div class="row">
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <figure class="col-md-5">
                            <input name="domainId" id="domainId" value="<?=$domain?>" style="resize: vertical;" class="form-control mb15 checkdomain" placeholder="Nhập tên miền cần kiểm tra…" name="keyword">
                            ...
                            <div class="row">
                                ...
                                &nbsp;
                                <div class="col-md-6">
                                    <button class="btn btn-danger fluid-width text-uppercase fs14 fw600 text-center" id="check" title="Kiểm tra tên miền" type="submit">
                                        Kiểm tra
                                    </button>
                                </div>
                                <!-- End: Show in Desktop -->
                    ...
                    <figure class="col-md-12">
                        <div class="more-s">
                            <ul>
                                <li><a href="/bang-gia-ten-mien-pde,2513"><i class="fa fa-table mr5"></i> Bảng giá tên miền</a></li>
