                        ...
                        <div class="box-all-nd">
                            <div class="box-nd">
                                <div class="nd-nd clearfix">
										...
										<div class="img-box-nd1">
											<div class="img-box">
												<a class="bg-lv"></a>
													...
													<a class="each notranslate" href="http://cedvietnam.com/dich-vu-tu-van-phat-trien-doanh-nghiep-nd,8976" title="<?php echo $cat['cat_name'] ?>">e
												</a>
												<div id="earth"></div>
										...
										<div class="img-box-nd">
											<div class="img-box">
												<a class="bg-lv"></a>
													...
													<?php else: ?>
														<a href="http://cedvietnam.com/dich-vu-cong-nd,8975" class="xemnhanh"></a>

													<?php endif; ?>
													<a href="http://cedvietnam.com/dich-vu-cong-nd,8975" title="<?php echo $cat['cat_name'] ?>">
									...
									<?php else: ?>
										<a href="http://cedvietnam.com/dich-vu-cong-nd,8975" >
                                            <h3><?php echo $cat['cat_name']; ?></h3>
                                        </a> 
									<?php endif; ?>
