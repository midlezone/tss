    ...
    <div class="industrial-product outstanding-project">
        <div class="container1">
			...
			<div class="gdl-header-wrapper ">
			  ...
			  <h3 class="gdl-header-title">Tin tức du lịch</h3>
                ...
                <div id="demo2">
                    <div id="owl-demo" class="owl-carousel">
                        ...
                        foreach ($hotnews as $ne) {
							...
							<div class="blog-content-wrapper">
							   ...
							   <div class="blog-content">
								   <?php echo substr($ne['news_sortdesc'],0,150)?>... 
								  <div class="clear"></div>
                        ...
                        <?php } ?>
									...
									<a class="blog-continue-reading1" href="/cam-nang-du-lich-nc,5558"> View All → </a>
