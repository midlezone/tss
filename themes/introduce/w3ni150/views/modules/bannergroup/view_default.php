<?php if ($banners && count($banners)) { ?>
    <div class="banner-top clearfix">
        <div class="slideshow">
            <div id="slider1_container" style="position: relative; width: 1168px; height: 527px; overflow: hidden;"> 

                <!-- Loading Screen -->
                <div u="loading" style="position: absolute; top: 0px; left: 0px;">
                    <div style="filter: alpha(opacity=70); opacity:0.7; position: absolute; display: block;
                         background-color: #000; top: 0px; left: 0px;width: 100%;height:100%;"> </div>
                    <div style="position: absolute; display: block; background: url(<?=Yii::app()->baseUrl?>/img/wating.gif) no-repeat center center;
                         top: 0px; left: 0px;width: 100%;height:100%;"> </div>
                </div>

                <!-- Slides Container -->
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1168px; height: 527px; overflow: hidden;">
                    <?php
                    foreach ($banners as $banner) {
                        ...
                        ?>
                        <div> <a href="<?php echo $banner['banner_link'] ?>" <?php echo Banners::getTarget($banner) ?> title="<?php echo $banner['banner_name']; ?>"><img src="<?php echo $banner['banner_src']; ?>" <?php if ($height) { ?> height="<?php echo $height ?>" <?php } if ($width) { ?> width="<?php echo $width; ?>" <?php } ?> alt="<?php echo $banner['banner_name']; ?>"/></a>
                    <?php if(trim($banner['banner_description'])) { ?><div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:350px; height:30px;"><?php echo $banner['banner_description']; ?></div><?php } ?>
                        </div>
                    <?php } ?>
                </div>
                ...
                <span u="arrowleft" class="jssora05l" style="top: 260px; left: 8px;"> </span> <span u="arrowright" class="jssora05r" style="top: 260px; right: 8px;"> </span> 
            </div>
        </div>
        ...
        <script>
                                        jQuery(document).ready(function ($) {
                                            ...
                                            var _SlideshowTransitions = [
                                                //fade twins
                                                {$Duration:2000,$Opacity:2,$Brother:{$Duration:3000,$Opacity:2}}
                                                //Rotate Overlap
...
//                                                {$Duration: 1600, x: -0.2, $Delay: 40, $Cols: 12, $During: {$Left: [0.4, 0.6]}, $SlideOut: true, $Formation: $JssorSlideshowFormations$.$FormationStraight, $Assembly: 260, $Easing: {$Left: $JssorEasing$.$EaseInOutExpo, $Opacity: $JssorEasing$.$EaseInOutQuad}, $Opacity: 2, $Outside: true, $Round: {$Top: 0.5}, $Brother: {$Duration: 1000, x: 0.2, $Delay: 40, $Cols: 12, $Formation: $JssorSlideshowFormations$.$FormationStraight, $Assembly: 1028, $Easing: {$Left: $JssorEasing$.$EaseInOutExpo, $Opacity: $JssorEasing$.$EaseInOutQuad}, $Opacity: 2, $Round: {$Top: 0.5}}}
                                            ...
                                            function ScaleSlider() {
                                                ...
                                                if (parentWidth)
                                                    jssor_slider1.$ScaleWidth(Math.min(parentWidth, 1168));
                                                else
