        ...
        <div class="box-main-one"> 
            ...
            <div class="list grid clearfix">
                <?php foreach ($products as $product) { ?>
                    <div class="list-item detail" src="<?php echo Yii::app()->createUrl('/economy/product/getproductinfo', array('id' => $product['id'], 'alias' => $product['alias'])) ?>" target-detail=".hover-list-content .category_product_detail_div" show-loading="true">
