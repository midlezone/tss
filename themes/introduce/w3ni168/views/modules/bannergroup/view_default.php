...
<div class="slider clearfix">
    <div id="slider1_container" style="position: relative;width:780px; height: 340px; overflow: hidden;"> 
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 780px; height: 340px; overflow: hidden;">
            <?php foreach ($banners as $banner) { ?>
            <div> 
                <a u=image href="<?php echo $banner['banner_link'] ?>">
                    <img alt="<?php echo $banner['banner_name']; ?>" src="<?php echo $banner['banner_src']; ?>" />
                </a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:340px; height:30px;"> <?php echo $banner['banner_name']; ?> </div>
            </div>
            <?php } ?>
        </div>
...
<script>
    jQuery(document).ready(function ($) {
        ...
        function ScaleSlider() {
            ...
            if (parentWidth)
                jssor_slider1.$ScaleWidth(Math.min(parentWidth, 780));
            else
