<?php if ($banners && count($banners)) { ?>
    <div id="slider1_container" style="position: relative; width: 820px; height: 250px; overflow: hidden;">
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 820px; height: 250px; overflow: hidden;">
            <?php
            foreach ($banners as $banner) {
                ...
                ?>
                <div>
                    <a u=image href="<?php echo $banner['banner_link'] ?>">
                    ...
                    <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 200px;  height:30px; background-color: rgba(0, 0, 0, 0.4); color:#fff; text-transform:uppercase; line-height:30px; padding:0 10px; font-size:18px;"> 
        ...
        <span u="arrowleft" class="jssora05l" style="top: 100px; left: 8px;">
        </span>
        <span u="arrowright" class="jssora05r" style="top: 100px; right: 8px;">
        </span>
    </div>
<?php } ?>
