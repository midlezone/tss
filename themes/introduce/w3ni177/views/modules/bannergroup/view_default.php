...
<?php if ($banners && count($banners)) { ?>
    <div class="slider clearfix">
        <div id="slider1_container" style="position: relative;width:930px; height: 339px; overflow: hidden;"> 
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 930px; height: 339px; overflow: hidden;">
                <?php
                foreach ($banners as $banner) {
                    ...
                    <div>
                        <a u=image href="<?php echo $banner['banner_link'] ?>"> 
                            <img alt="<?php echo $banner['banner_name']; ?>" src="<?php echo $banner['banner_src']; ?>" <?php if ($height) { ?> height="<?php echo $height ?>" <?php } if ($width) { ?> width="" <?php } ?> /> 
                        </a>
                        <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:340px; height:30px;"> 
...
<script>
    jQuery(document).ready(function ($) {
        ...
        function ScaleSlider() {
            ...
            if (parentWidth)
                jssor_slider1.$ScaleWidth(Math.min(parentWidth, 930));
            else
