                                ...
                                <div class="list-item">
                                    <div class="list-content clearfix">
                                        <div class="list-content-box">
                                            <?php
                                            $discount = 0;
                                            if ($product_new['price_market'] && $product_new['price_market'] > 0 && $product_new['price'] && $product_new['price'] > 0) {
                                                $discount = ClaProduct::getDiscount($product_new['price_market'], $product_new['price']);
                                            }
                                            if ($discount > 0) {
                                                ?>
                                ...
                                <div class="list-item">
                                    <div class="list-content clearfix">
                                        <div class="list-content-box">
                                            <?php
                                            $discount = 0;
                                            if ($product_group['price_market'] && $product_group['price_market'] > 0 && $product_group['price'] && $product_group['price'] > 0) {
                                                $discount = ClaProduct::getDiscount($product_group['price_market'], $product_group['price']);
                                            }
                                            if ($discount > 0) {
                                                ?>
                                                <span class="icon-km">-<?php echo $discount; ?>%</span>
