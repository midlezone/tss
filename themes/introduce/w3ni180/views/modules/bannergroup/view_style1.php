<?php if ($banners && count($banners)) { ?>
    <div id="slider1_container" style="position: relative; margin: 0 auto;top: 0px; left: 0px; width: 1366px; height: 425px; overflow: hidden;">
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1366px;height: 425px; overflow: hidden;">
            <?php
            foreach ($banners as $banner) {
                ...
                <div>
                    ...
                    <div u="caption" t="MCLIP|R" du="500" t2="NO" style="position: absolute; top: 150px; left:300px;color: #ffffff;font-size: 48px;font-weigt: bold;">
