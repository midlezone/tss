<?php if ($banners && count($banners)) { ?>
    <div id="slider">
        <div class="container-slider">
            <div id="slider1_container" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1080px; height: 390px; overflow: hidden;box-shadow: 0 0 5px rgba(0,0,0,.5)">

                <!-- Slides Container -->
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1080px; height: 390px; overflow: hidden;">
                    <?php
