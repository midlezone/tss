        ...
        <div id="slider2_container" style="position: relative; width: 690px;height: 340px; overflow: hidden;">
            ...
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 690px; height: 340px; overflow: hidden;">
                ...
                foreach ($banners as $banner) {
                    ...
                    ?>
                    <div>
                        <a u=image <?php echo Banners::getTarget($banner) ?> href="<?php echo $banner['banner_link'] ?>" title="<?php echo $banner['banner_name'] ?>">
                        ...
                        <?php if ($banner['banner_description']) { ?>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:0px; top: 280px; height: 60px; width:690px; background-color: rgba(0, 0, 0, 0.37); color:#fff; padding-left:20px; padding-top: 10px; line-height:20px;"> 
