<?php if ($banners && count($banners)) { ?>
    <div class="slider">
        <div id="slider1_container" style="position: relative; width: 1140px;
            ...
            <!-- Slides Container -->
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1140px; height: 390px;
                 overflow: hidden;">
                 <?php
                 foreach ($banners as $banner) {
                    ...
                    <div>
                        ...
                        <div u=caption t="*" class="captionOrange"  style="position:absolute; left:100px; top: 30px; width:500px; height:40px; font-size:30px; color:#333; text-shadow: -1px 0 #FFF, 0 1px #FFF, 1px 0 #FFF, 0 -1px #FFF;
            ...
            <span u="arrowleft" class="jssora05l" style="top: 180px; left: 10px;">
            </span>
            <!-- Arrow Right -->
            <span u="arrowright" class="jssora05r" style="top: 180px; right: 10px;">
