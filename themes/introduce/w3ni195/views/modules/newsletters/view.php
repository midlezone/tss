        ...
        <div class="form-group no-margin-left no-margin-right">
            <div class="input-group email1">
                ...
                <span class="input-group-addon" style="font-size: 14px;">
                    <?php echo CHtml::submitButton(Yii::t('common', 'signup'), array('class' => 'btn btn-sm', 'id' => 'newslettersubmit', 'style' => 'padding:0;  background:#e9931a; color:#fff; border-radius: 0px;  display: block;')); ?>
                </span> 
            </div>
            <div>
