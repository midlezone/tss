<?php if ($user_id) { ?>
    ...
    <h3 class="username-title"> <?php echo Yii::t('realestate', 'realestate_create'); ?> </h3>
    <div class="wrap_create_real_estate">
        ...
        $form = $this->beginWidget('CActiveForm', array(
            'id' => 'real-estate-form',
            'action' => Yii::app()->createUrl('profile/profile/realestateCreate'),
        ...
        <div class="w3-form-group form-group">
            ...
            <div class="col-xs-10 w3-form-button" style="padding: 0px;">
                <button style="width: 100px;" onclick="submit_real_estate_form();" type="button" class="btn btn-primary"><?php echo Yii::t('common', 'create_new'); ?></button>
            </div>
        </div>
