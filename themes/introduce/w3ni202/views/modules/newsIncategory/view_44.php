                        ...
                        foreach ($news as $ne) {
                            ...
                            <li>
                                <a href="<?php echo $ne['link']; ?>" title="<?php echo $ne['news_title']; ?>">
                                    <img style="height:400px;" src="<?php echo ClaHost::getImageHost() . $ne['image_path'] . 's450_450/' . $ne['image_name']; ?>" alt="<?php echo $ne['image_name']; ?>" data-description="<p><?php echo $ne['news_sortdesc']; ?></p>" />
