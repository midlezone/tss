<?php if ($banners && count($banners)) { ?>
    <div id="slider1_container" style="position: relative; width: 1080px;
         height: 370px; overflow: hidden;">     <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1080px; height: 370px;
             overflow: hidden;">
             <?php
        ...
        <div u="navigator" class="jssorb21" style="bottom: 16px; right: 10px;">
            <div u="prototype"></div>
        </div>

        <span u="arrowleft" class="jssora05l" style="top: 150px; left: 20px;">
        </span>
        <!-- Arrow Right -->
        <span u="arrowright" class="jssora05r" style="top: 150px; right: 20px;">
        </span>
