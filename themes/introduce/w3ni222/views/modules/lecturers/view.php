...
<script>
    $(document).ready(function () {
        ...
        $('.featured-photos .box-img').hover(function() {
            $(this).find('.box-img-cont a img').css('transform', 'scale(1.15, 1.15)');
            $(this).find('.box-img-cont a img').css('transition', 'all 0.3s ease 0s');
        }, function() {
            $(this).find('.box-img-cont a img').css('transform', 'scale(1, 1)');
        });
