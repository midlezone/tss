<?php if ($banners && count($banners)) { ?>
    <div id="slider">
        <div id="slider1_container" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1349px; height: 452px; overflow: hidden;">

            <!-- Slides Container -->
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1349px; height: 452px; overflow: hidden;">
                <?php
                foreach ($banners as $banner) {
                    ...
                    <div>
                        ...
                        <div u="caption" t="NO" t3="RTT|2" r3="137.5%" du3="0000" d3="000" style="position: absolute; width: 445px; height: 300px; top: 0px; left: 180px;  margin:0 auto">
                            <div u="caption" class="tenbanner" t="MCLIP|R" du="500" t2="NO" style="position: absolute; width: 1349px; height: 80px; top: 400px; left:0px; font-size:30px; color:#333; text-shadow: -1px 0 #FFF, 0 1px #FFF, 1px 0 #FFF, 0 -1px #FFF;
