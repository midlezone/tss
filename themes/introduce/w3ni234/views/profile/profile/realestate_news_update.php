...
if ($user_id) {
    ...
    <h3 class="username-title"> <?php echo Yii::t('common', 'update'); ?> <?php echo $model->name ?> </h3>
    ...
    <?php if (Yii::app()->user->hasFlash('success')): ?>
        ...
        $form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => Yii::app()->createUrl('profile/profile/realestateNewsUpdate', array('realestatenews_id' => $realestatenews_id)),
    ...
    <?php echo $form->error($model, 'description'); ?>
        ...
        <div class="w3-form-group form-group">
            ...
            <div class=" col-xs-10 w3-form-button" style="padding-left: 0px;">
                <button type="button" class="btn btn-primary" onclick="submit_realestate_news_form();"><span><?php echo Yii::t('common', 'update'); ?></span></button>
            </div>
        </div>
