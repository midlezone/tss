...
if ($user->type == ActiveRecord::TYPE_LEADER_USER) { ?>
    ...
    <div class="wrap_create_real_estate">
        ...
        $form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => Yii::app()->createUrl('profile/profile/realestateProjectUpdate', array('rp_id' => $rp_id)),
        ...
        <div class="w3-form-group form-group">
            ...
            <div class="col-xs-10 w3-form-button" style="padding: 0px;">
                <button style="width: 100px;" onclick="submit_realestateproject();" type="button" class="btn btn-primary"><?php echo Yii::t('common', 'update'); ?></button>
            </div>
        </div>
