            ...
            <div class="product-info-col1">
                ...
                <div class="purchaser">
                    <a href="<?php echo Yii::app()->createUrl('/economy/shoppingcart/add', array('pid' => $model->id)); ?>" class="a-btn">
                        <span class="a-btn-text"><?php echo Yii::t('shoppingcart', 'Đặt tour'); ?></span> 
        ...
        <?php if ($product['product_desc'] || $attributesShow && count($attributesShow)) { ?>
            <div class="tab">
                <ul role="tablist" class="nav nav-tabs">
                    <li class="active"><a class="searchbychar"  data-toggle="tab" role="tab" data-target="gioi-thieu" href="javascript:void(0)">Giới thiệu</a></li>
                    <li class=""><a class="searchbychar" href="javascript:void(0)" data-target="lich-trinh">Lịch trình</a></li>
                    <li class=""><a class="searchbychar"  data-toggle="tab" role="tab" href="javascript:void(0)" data-target="luu-y">Lưu ý</a></li>

            <!--<li class="active"><a data-toggle="tab" role="tab" href="#home"><?php echo 'Lịch trình tour'; ?></a></li>-->
                </ul>
