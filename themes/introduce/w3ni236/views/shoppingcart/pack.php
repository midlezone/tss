        ...
        <tr class="sc-totalprice-row">
            <td colspan="5">
                <div class="sc-totalprice-text">
                 ...
                 <div class="sc-totalprice-text">
                    <span><?php echo Yii::t('shoppingcart', 'tranport_price') ?>:</span>
                </div>
                 <div class="sc-totalprice-text">
            ...
            <td style="text-align:right;">
                <div class="sc-totalprice"><?php echo $shoppingCart->getTotalPriceWithTranportPrice(true,$method_id); ?></div>
                <div class="sc-totalprice transportprc"><span class="pricetext">0</span><span class="currencytext">đ</span></div>
                <div class="sc-totalprice sc-totalprice-fn"><?php echo $shoppingCart->getTotalPriceWithTranportPrice(true,$method_id); ?></div>
            </td>
        </tr>
    </tbody>
</table>