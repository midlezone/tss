<?php if ($banners && count($banners)) { ?>
    <div id="slider2_container" style="position: relative; width: 1920px;
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1920px; height: 1095px;
             overflow: hidden;">
             <?php
        ...
        <span u="arrowleft" class="jssora05l" style="top: 48%; left: 8px;">
        </span>
        <!-- Arrow Right -->
        <span u="arrowright" class="jssora05r" style="top: 48%; right: 8px;">
        </span>
    </div>
